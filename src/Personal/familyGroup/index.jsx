  ...
  return (
    <View style={{ flex: 1, flexDirection: 'column' }}>
      ...
      <View style={[styles.deviceBody, { flex: 1, flexDirection: 'column' }]}>
        ...
        <ScrollView>
          {members.map((value, idx) => <FamilyCard key={`ListGroup:${idx + 1}`} username={value.username} note="Father" imgUrl="https://s3.amazonaws.com/uifaces/faces/twitter/ladylexy/128.jpg" />)}
        </ScrollView>
